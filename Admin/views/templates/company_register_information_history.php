...
<body>
	...
	font-weight: bold; width: 100%; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				    Company Register Information History
				  </div>
				  <div class="card-body">
          ...
          <?php
            if ($user_details->num_rows > 0) {
              echo '
                        ...
                        <th scope="col">Register State</th>
                        <th scope="col">Register tel no</th>
                        <th scope="col">Register Fax no</th>
                        <th scope="col">Register Email</th>
                        <th scope="col">Register Internet</th>
                    ...
                    while($row = $user_details->fetch_assoc()) {
                      //  echo "Id: " . $row["Id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. $row["email"].$row["branch"].$row["block"].$row["gender"].$row["event"];
                        ...
                        echo "<tbody>";
												...
												echo  "<td>".$row["register_address"]."</td>";
												echo  "<td>".$row["register_city"]."</td>";
												echo  "<td>".$row["register_state"]."</td>";
												echo  "<td>".$row["register_telno"]."</td>";
												echo  "<td>".$row["register_faxno"]."</td>";
												echo  "<td>".$row["register_email"]."</td>";
												echo  "<td>".$row["register_internet"]."</td>";
