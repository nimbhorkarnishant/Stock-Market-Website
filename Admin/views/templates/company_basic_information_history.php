...
<body>
	...
	<main>
		<div class="container" style="margin-left:-10px;">
				<div class="card" style="margin-top: 5vh; width:160%">
	...
	font-weight: bold; width: 100%; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				    Company Basic Information History
				  </div>
				  <div class="card-body">
          ...
          <?php
            if ($user_detail->num_rows > 0) {
              echo '
                        ...
                        <th scope="col">Company Tel no</th>
                        <th scope="col">Company Fax no</th>
                        <th scope="col">Company  Email</th>
                        <th scope="col">Company  Internet</th>
                    ...
                    while($row = $user_detail->fetch_assoc()) {
                      //  echo "Id: " . $row["Id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. $row["email"].$row["branch"].$row["block"].$row["gender"].$row["event"];
                        ...
                        echo "<tbody>";
                          ...
                          echo  "<td>".$row["company_pincode"]."</td>";
                          echo  "<td>".$row["company_telno"]."</td>";
                          echo  "<td>".$row["company_faxno"]."</td>";
                          echo  "<td>".$row["company_email"]."</td>";
                          echo  "<td>".$row["company_internet"]."</td>";
                          echo  "<td>".$row["company_overview"]."</td>";
