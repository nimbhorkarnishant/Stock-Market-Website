...
<body>
  ...
  if (isset($_SESSION['Company_register_add_message'])) {
	...
	font-weight: bold; width: 60vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				    Add Company  Registers Details
				  </div>

				  <div class="card-body">
            <form class="" action="?act=Adding_company_register_detail" method="post">
					  ...
					  <div class="input-group mb-3">
					   ...
					   <input type="text" class="form-control" name="register_name" value='' aria-describedby="basic-addon1">
					  </div>
					  <div class="input-group mb-3 ">
					    <div class="input-group-prepend">
					    <span class="input-group-text" id="basic-addon1">Registers Address</span>
					  </div>
					   <input type="text" class="form-control" name="register_address" value='' aria-describedby="basic-addon1">
					  </div>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Registers City</span>
            </div>
            <input type="text" class="form-control" name="register_city" value='' aria-describedby="basic-addon1">
            </div>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Register State</span>
            </div>
            <input type="text" class="form-control" name="register_state" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Registers Telno</span>
          </div>
          <input type="text" class="form-control" name="register_telno" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Registers Fax No</span>
          </div>
          <input type="text" class="form-control" name="register_faxno" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Registers Email</span>
          </div>
          <input type="text" class="form-control" name="register_email" value='' aria-describedby="basic-addon1">
        </div>
  			<div class="input-group mb-3">
  			  <div class="input-group-prepend">
  			    <span class="input-group-text" id="basic-addon1">Registers Internet</span>
  			  </div>
  			  <input type="text" class="form-control" name="register_internet" value='' aria-describedby="basic-addon1">
  			</div>
        <button class="btn btn-success" style="float: left;margin-bottom:20px;" type="submit" class="btn btn-primary" name="registers_id" value='<?php echo $company_registers_details[0] ?>'>
          Save company registers Details
        </button>
        </form>
				  </div>
				</div>
