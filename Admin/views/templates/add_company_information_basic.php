...
<body>
  ...
  if (isset($_SESSION['Company_detail_add_message'])) {
	...
	font-weight: bold; width: 60vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				  ...
				  <div class="card-body">
            <form class="" action="?act=Adding_company_detail" method="post">

						<!--<div class="input-group mb-3">
  					  <div class="input-group-prepend">
  					    <span class="input-group-text" id="basic-addon1">Comapany Id</span>
  					  </div>
					    <input type="text" class="form-control" name="company_id" value='' aria-describedby="basic-addon1" disabled>
					  </div>--->
				  	...
				  	<div class="input-group mb-3">
					    ...
					    <input type="text" class="form-control" name="company_name" value='' aria-describedby="basic-addon1">
					  </div>
					  <div class="input-group mb-3">
					    <div class="input-group-prepend">
					      <span class="input-group-text" id="basic-addon1">Company Address</span>
					    </div>
					   <input type="text" class="form-control" name="company_address" value='' aria-describedby="basic-addon1">
					  </div>
					  <div class="input-group mb-3 ">
					    <div class="input-group-prepend">
					    <span class="input-group-text" id="basic-addon1">Company City</span>
					  </div>
					   <input type="text" class="form-control" name="company_city" value='' aria-describedby="basic-addon1">
					  </div>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Company State</span>
            </div>
            <input type="text" class="form-control" name="company_state" value='' aria-describedby="basic-addon1">
            </div>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Company Pincode</span>
            </div>
            <input type="text" class="form-control" name="company_pincode" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Company_Telno</span>
          </div>
          <input type="text" class="form-control" name="company_telno" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Company Fax Number</span>
          </div>
          <input type="text" class="form-control" name="company_faxno" value='' aria-describedby="basic-addon1">
          </div>
          <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">Company Email</span>
          </div>
          <input type="text" class="form-control" name="company_email" value='' aria-describedby="basic-addon1">
        </div>
  			<div class="input-group mb-3">
  			  <div class="input-group-prepend">
  			    <span class="input-group-text" id="basic-addon1">Company Internet</span>
  			  </div>
  			  <input type="text" class="form-control" name="company_internet" value='' aria-describedby="basic-addon1">
  			</div>
        <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">Company Overview </span>
        </div>
        <input type="text" class="form-control" name="company_overview" value='' aria-describedby="basic-addon1">
        </div>
        <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">Company Code</span>
        </div>
        <input type="text" class="form-control" name="company_code" value='' aria-describedby="basic-addon1">
      </div>
        <button class="btn btn-success" style="float: left;margin-bottom:20px;" type="submit" class="btn btn-primary" name="company_id" value=''>
