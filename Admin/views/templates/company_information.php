...
<body>
  ...
  ?>
	...
	font-weight: bold; width: 65vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				  ...
				  <div class="card-body">
				  	<form class="form-inline" action="?act=filter_by_company_name" method="post">
					  <div class="form-group mx-sm-3 mb-2">
					    	<label for="inputEmail2" class="sr-only"></label>
					    	<input type="text"  name="filter_by" class="form-control" id="inputEmail2" placeholder="Search By Company Code or city" style="width:300px;">
					  </div>
            ...
            <div class="form-group mx-sm-3 mb-2">
              <form class="" action="?act=filter_by_company_email" method="post">
                <label for="inputEmail3" class="sr-only"></label>
					    <input type="text" name="filter_by" class="form-control" id="inputEmail3" placeholder="Search By email " style="width:19%">
					  </div>
              ...
              echo '
					         <thead class="table-dark">
					            <tr>
        					      ...
        					      <th scope="col">Comapany Email</th>
        					      <th scope="col">Company City</th>
        					      <th scope="col">Company Code</th>
        					      <th scope="col"></th>
					             </tr>
					          </thead>';
                    while($row = $company_detail->fetch_assoc()) {
                      //  echo "Id: " . $row["Id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. $row["email"].$row["branch"].$row["block"].$row["gender"].$row["event"];
                        ...
                        echo "<tbody>";
                          ...
                          echo  '<td><form  action="?act=view_company_detail" method="post">'.
                                  '<button class="btn-sm btn-warning" type="submit" name="company_id" value='.$id.">"."View Details"."</button>"
                                  .'</form></td>';
                          echo "</tr>";
                        echo "</tbody>";
