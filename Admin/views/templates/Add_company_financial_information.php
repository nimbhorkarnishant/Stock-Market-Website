...
<body>
  ...
  if (isset($_SESSION['company_financial_detail_add_message'])) {
	...
	font-weight: bold; width: 60vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				    Add Company Finanacial Details
				  </div>

				  <div class="card-body">
            <form class="" action="?act=adding_company_financial_detail" method="post">
    					  ...
    					  <div class="input-group mb-3">
    					   ...
    					   <input type="text" class="form-control" name="finance_field" aria-describedby="basic-addon1" value=''>
    					  </div>
    					  <div class="input-group mb-3 ">
    					    <div class="input-group-prepend">
    					    <span class="input-group-text" id="basic-addon1">Quarter 1</span>
    					  </div>
    					   <input type="text" class="form-control" name="quarter1" aria-describedby="basic-addon1" value=''>
    					  </div>
                <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">Quarter 2</span>
                </div>
                <input type="text" class="form-control" aria-describedby="basic-addon1" name="quarter2" value=''>
                </div>
                <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">Quarter 5</span>
                </div>
                <input type="text" class="form-control" aria-describedby="basic-addon1" name="quarter3" value=''>
              </div>
              <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">Quarter 4 </span>
              </div>
              <input type="text" class="form-control" aria-describedby="basic-addon1" name="quarter4" value=''>
            </div>
            <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Quarter 5 </span>
            </div>
            <input type="text" class="form-control" name="quarter5" aria-describedby="basic-addon1" value=''>
          </div>
            <button class="btn btn-success" style="float: left;margin-bottom:20px;" type="submit" class="btn btn-primary" >
              Save Details
            </button>
            </form>
