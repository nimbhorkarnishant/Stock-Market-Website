...
<body>
  ...
  ?>
	...
	font-weight: bold; width: 65vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
				  ...
				  <div class="card-body">
				  	<form class="form-inline" action="?act=filter_by_company_valuation_id" method="post">
          ...
          <?php
            if ($company_valuation_detail->num_rows > 0) {
              echo '
                    ...
                    while($row = $company_valuation_detail->fetch_assoc()) {
                      //  echo "Id: " . $row["Id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. $row["email"].$row["branch"].$row["block"].$row["gender"].$row["event"];
                        ...
                        echo "<tbody>";
                          ...
                          echo  '<td><form  action="?act=view_company_valuation_detail" method="post">'.
                                  '<button class="btn-sm btn-warning" type="submit" name="valuation_id" value='.$id.">"."View Details"."</button>"
                                  .'</form></td>';
                          echo "</tr>";
                        echo "</tbody>";
