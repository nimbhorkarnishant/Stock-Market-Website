...
<body>
  ...
  ?>
	...
	font-weight: bold; width: 65vw; padding:2px; background-color: #34495E  ; font-size: 1.2rem; ">
            ...
            <div class="form-group mx-sm-3 mb-2">
              <form class="" action="?act=filter_by_register_email" method="post">
          ...
          <?php
            if ($company_register_detail->num_rows > 0) {
              echo '
                    ...
                    while($row = $company_register_detail->fetch_assoc()) {
                      //  echo "Id: " . $row["Id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]. $row["email"].$row["branch"].$row["block"].$row["gender"].$row["event"];
                        ...
                        echo "<tbody>";
                          ...
                          echo  "<td>".$row["register_city"]."</td>";
                          echo  '<td><form  action="?act=edit_company_register_detail" method="post">'.
                                  '<button class="btn-sm btn-warning" type="submit" name="registers_id" value='.$id.">"."View Details"."</button>"
                                  .'</form></td>';
                          echo "</tr>";
                        echo "</tbody>";
