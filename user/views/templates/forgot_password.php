...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container" style="margin-top:120px;">
      <div class="row">
        <div class="row">
          <p style="text-align:center;color:darkgreen;" >Please enter your email address below and we will send you information to change your password.</p>
          <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="text-center">
                  <h3><i class="fa fa-lock fa-4x"></i></h3>
                    <h2 class="text-center" style="color:darkgreen;">Forgot Password?</h2>
                      <p style="color:darkgreen;">You can reset your password here.</p>
                        <div class="panel-body">
                          <form  class="form" method="post" action="?act=sending_email">
                            <fieldset>
                              ...
                              <div class="form-group">
                            <button class="button_submit"  type="submit">Send Email</button>
                            </div>
                          </fieldset>
                        </form>
                      </div>
